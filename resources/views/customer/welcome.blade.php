...
@section('content')
    ...
    <section id="tentang" class="w-full mx-auto px-4 py-12 md:py-16 flex flex-col items-center gap-10 lg:gap-14">
        ...
        <div data-aos="fade-up">
            <x-section-header label="Tentang Kami" title="Siapa MEX Berlian Dirgantara?"
    ...
    <section class="w-full mx-auto py-12 md:py-16 flex flex-col items-center gap-12" id="layanan">
        ...
        <div data-aos="fade-up">
            <x-section-header label="Layanan" title="Kami Menawarkan"
        ...
        <div x-data="{
                    ...
                    startAutoScroll() {
                        this.intervalId = setInterval(() => {
                            ...
                            if (slider.scrollLeft + slider.clientWidth >= slider.scrollWidth - 10) {
                                ...
                                slider.scrollBy({ left: slider.firstElementChild.clientWidth, behavior: 'smooth' });
                            }
                        }, 3000); 
                    },
                    stopAutoScroll() {
                ...
                }" x-init="startAutoScroll()" x-ref="slider" @mouseenter="stopAutoScroll()" @mouseleave="startAutoScroll()"
            @touchstart="stopAutoScroll()" @touchend="startAutoScroll()"
            class="flex overflow-x-auto snap-x snap-mandatory gap-4 md:gap-6 w-full pb-6 px-4 md:px-8 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <div data-aos="fade-up" data-aos-delay="200"
                class="w-[85vw] md:w-[calc((100%-1.5rem)/2)] lg:w-[calc((100%-3rem)/3)] shrink-0 snap-center snap-always bg-white rounded-[24px] p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-50 flex flex-col justify-between gap-6 h-full">
                <div class="flex justify-between items-start gap-4">
                    <h4 class="text-black text-xl md:text-2xl font-semibold font-['Poppins'] leading-snug">Layanan<br>Door
                        to Door</h4>
                    <div
                        class="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-red/10 text-red flex items-center justify-center shrink-0">
                        <i class="ri-door-open-fill text-2xl md:text-3xl"></i>
                    </div>
                </div>
                <p class="text-gray-700 text-sm md:text-base font-normal font-['Poppins'] leading-relaxed">
                    Melayani penjemputan hingga pengantaran barang langsung ke alamat tujuan secara praktis dan efisien.
                </p>
            </div>
            ...
            <div data-aos="fade-up" data-aos-delay="300"
                class="w-[85vw] md:w-[calc((100%-1.5rem)/2)] lg:w-[calc((100%-3rem)/3)] shrink-0 snap-center snap-always bg-white rounded-[24px] p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-50 flex flex-col justify-between gap-6 h-full">
                <div class="flex justify-between items-start gap-4">
                    <h4 class="text-black text-xl md:text-2xl font-semibold font-['Poppins'] leading-snug">Layanan Trucking
                    </h4>
                    <div
                        class="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-red/10 text-red flex items-center justify-center shrink-0">
                        <i class="ri-truck-fill text-2xl md:text-3xl"></i>
                    </div>
                </div>
                <p class="text-gray-700 text-sm md:text-base font-normal font-['Poppins'] leading-relaxed">
                    Distribusi dan pengangkutan barang menggunakan armada darat untuk mendukung proses pengiriman antar
                    lokasi.
                </p>
            </div>
            ...
            <div data-aos="fade-up" data-aos-delay="400"
                class="w-[85vw] md:w-[calc((100%-1.5rem)/2)] lg:w-[calc((100%-3rem)/3)] shrink-0 snap-center snap-always bg-white rounded-[24px] p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-50 flex flex-col justify-between gap-6 h-full">
                <div class="flex justify-between items-start gap-4">
                    <h4 class="text-black text-xl md:text-2xl font-semibold font-['Poppins'] leading-snug">Layanan Packing
                        Barang</h4>
                    <div
                        class="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-red/10 text-red flex items-center justify-center shrink-0">
            ...
            <div data-aos="fade-up" data-aos-delay="500"
                ...
                <p class="text-gray-700 text-sm md:text-base font-normal font-['Poppins'] leading-relaxed">
                    Memudahkan pelanggan memantau status dan posisi barang secara realtime melalui sistem pelacakan resi.
                </p>
            </div>
            ...
            <div data-aos="fade-up" data-aos-delay="600"
                class="w-[85vw] md:w-[calc((100%-1.5rem)/2)] lg:w-[calc((100%-3rem)/3)] shrink-0 snap-center snap-always bg-white rounded-[24px] p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-50 flex flex-col justify-between gap-6 h-full">
                <div class="flex justify-between items-start gap-4">
                    <h4 class="text-black text-xl md:text-2xl font-semibold font-['Poppins'] leading-snug">Layanan<br>Port
                        to Port</h4>
                    <div
                        class="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-red/10 text-red flex items-center justify-center shrink-0">
    ...
    <section class="relative w-full py-24 md:py-32 flex flex-col justify-center items-center overflow-hidden" id="tracking">
        ...
        <div class="relative z-20 w-full max-w-4xl mx-auto px-4 flex flex-col items-center gap-6 text-center">
            ...
            <form data-aos="zoom-in" data-aos-delay="200" action="{{ route('tracking.show') }}" method="GET"
                class="w-full max-w-xl mt-4 md:mt-4 p-2 md:p-2 bg-white rounded-full flex items-center shadow-2xl outline outline-1 outline-slate-200">
                <div class="pl-4 pr-2 text-slate-400">
                    <i class="ri-barcode-box-line text-2xl"></i>
                </div>
                <input type="text" name="no_resi" placeholder="Masukkan ID Resi..."
                    class="flex-1 bg-transparent text-black text-base md:text-lg font-normal font-['Poppins'] placeholder-slate-400 focus:outline-none focus:ring-0 border-none px-2 py-2"
                    required />
                <button type="submit"
                    class="hidden lg:flex w-12 h-12 md:w-12 md:h-12 bg-red hover:bg-redhover text-white rounded-full justify-center items-center shrink-0 transition-colors duration-200 shadow-md">
